...
- `AZURE_OPENAI_ENDPOINT`: Copy the **Project endpoint** box.
- `AZURE_OPENAI_KEY`: Copy the **Project API Key** box.
...
Repeat this process to collect the Phi-4 endpoint, with one major exception.
