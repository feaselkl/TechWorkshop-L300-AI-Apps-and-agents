...
azure_ai_project = os.getenv("gpt_endpoint")
```
...
azure_openai_config = { 
    "azure_endpoint": f"{os.environ.get('FOUNDRY_ENDPOINT')}/openai/deployments/{os.environ.get('gpt_deployment')}/chat/completions",
